...
//MARK: Property
    ...
    private let stepBarItem = CustomBarBtnItem(buttonFrame: CGRect(x: windowBounds.width/5*2-18-25, y: 0, width: 50, height: 22),title:"Steps", itemType:.right)
    private let runningBarItem = CustomBarBtnItem(buttonFrame: CGRect(x: windowBounds.width/5*2-18-25, y: 0, width: 50, height: 22),title:"Run", itemType:.left)
